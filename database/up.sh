...
PGPASSWORD=tp_web psql -U tp_web -h localhost -t -f $BASEDIR/departement.sql tp_web

# code_postal

PGPASSWORD=tp_web psql -U tp_web -h localhost -t -f $BASEDIR/code_postal.sql tp_web
